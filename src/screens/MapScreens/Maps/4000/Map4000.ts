...
export class Map4000 extends MapFactory {
    ...
    private setIcons() {
        ...
        const ki1 = new MapIcon({x: 3135, y: 2187, name: MAP_ICON.DROP_POINT, label: ''});
        this.fooIcon = ki1;
        this.mapContainer.addChild(ki1);
        const ki2 = new MapIcon({x: 3171, y: 2193, name: MAP_ICON.SEARCH_RECOVER, label: 'BACKS AGAINST THE WALL'});
        this.fooIcon = ki2;
        this.mapContainer.addChild(ki2);
        const ki3 = new MapIcon({x: 3198, y: 2169, name: MAP_ICON.FAST_TRAVEL, label: 'Pinewood St South'});
        this.fooIcon = ki3;
        this.mapContainer.addChild(ki3);
        const ki4 = new MapIcon({x: 3228, y: 2145, name: MAP_ICON.ASSAULT, label: ''});
        this.fooIcon = ki4;
        this.mapContainer.addChild(ki4);
        const ki5 = new MapIcon({x: 3141, y: 2082, name: MAP_ICON.REPORTED_CRIME, label: 'Paranoia'});
        this.fooIcon = ki5;
        this.mapContainer.addChild(ki5);
        const ki6 = new MapIcon({x: 3189, y: 2067, name: MAP_ICON.DROP_POINT, label: ''});
        this.fooIcon = ki6;
        this.mapContainer.addChild(ki6);
        const ki7 = new MapIcon({x: 3246, y: 2067, name: MAP_ICON.FAST_TRAVEL, label: 'ALLEN ST SOUTH'});
        this.fooIcon = ki7;
        this.mapContainer.addChild(ki7);
        const ki8 = new MapIcon({x: 3279, y: 2079, name: MAP_ICON.AgentSaboteur, label: 'WELCOME TO AMERICA, COMRADE'});
        this.fooIcon = ki8;
        this.mapContainer.addChild(ki8);
        const ki9 = new MapIcon({x: 3282, y: 2040, name: MAP_ICON.BAR, label: 'HO-OH BAR'});
        this.fooIcon = ki9;
        this.mapContainer.addChild(ki9);
        const ki10 = new MapIcon({x: 3276, y: 2040, name: MAP_ICON.GUN_FOR_HIRE, label: 'Monster Hunt'});
        this.fooIcon = ki10;
        this.mapContainer.addChild(ki10);
        const ki11 = new MapIcon({x: 3177, y: 2034, name: MAP_ICON.FAST_TRAVEL, label: 'Kabuki: Central'});
        this.fooIcon = ki11;
        this.mapContainer.addChild(ki11);
        const ki12 = new MapIcon({x: 3177, y: 2013, name: MAP_ICON.THIEF, label: 'FIXER, MERC, SOLDIER, SPY'});
        this.fooIcon = ki12;
        this.mapContainer.addChild(ki12);
        const ki13 = new MapIcon({x: 3198, y: 2013, name: MAP_ICON.DROP_POINT, label: ''});
        this.fooIcon = ki13;
        this.mapContainer.addChild(ki13);
        const ki14 = new MapIcon({x: 3258, y: 1986, name: MAP_ICON.FAST_TRAVEL, label: 'Allen Street'});
        this.fooIcon = ki14;
        this.mapContainer.addChild(ki14);
        const ki15 = new MapIcon({x: 3237, y: 1971, name: MAP_ICON.GUN_FOR_HIRE, label: 'SMALL MAN, BIG EVIL'});
        this.fooIcon = ki15;
        this.mapContainer.addChild(ki15);
        const ki16 = new MapIcon({x: 3213, y: 1953, name: MAP_ICON.FAST_TRAVEL, label: 'Bellevue Overwalk'});
        this.fooIcon = ki16;
        this.mapContainer.addChild(ki16);
        const ki17 = new MapIcon({x: 3189, y: 1941, name: MAP_ICON.ASSAULT, label: ''});
        this.fooIcon = ki17;
        this.mapContainer.addChild(ki17);
        const ki18 = new MapIcon({x: 3156, y: 1950, name: MAP_ICON.ASSAULT, label: ''});
        this.fooIcon = ki18;
        this.mapContainer.addChild(ki18);
        const ki19 = new MapIcon({x: 3150, y: 1899, name: MAP_ICON.TARROT, label: 'The Magican'});
        this.fooIcon = ki19;
        this.mapContainer.addChild(ki19);
        const ki20 = new MapIcon({x: 3189, y: 1893, name: MAP_ICON.BAR, label: "LIZZIE'S BAR"});
        this.fooIcon = ki20;
        this.mapContainer.addChild(ki20);
        const ki21 = new MapIcon({x: 3258, y: 1902, name: MAP_ICON.PSYCHO, label: "Help is on the Way"});
        this.fooIcon = ki21;
        this.mapContainer.addChild(ki21);
        const ki22 = new MapIcon({x: 3267, y: 1890, name: MAP_ICON.FAST_TRAVEL, label: "CREEK LOOP"});
        this.fooIcon = ki22;
        this.mapContainer.addChild(ki22);
        const ki23 = new MapIcon({x: 3309, y: 1857, name: MAP_ICON.DROP_POINT, label: ""});
        this.fooIcon = ki23;
        this.mapContainer.addChild(ki23);
        const ki24 = new MapIcon({x: 3300, y: 1836, name: MAP_ICON.REPORTED_CRIME, label: "PROTECT AND SERVE"});
        this.fooIcon = ki24;
        this.mapContainer.addChild(ki24);
        const ki25 = new MapIcon({x: 3201, y: 1830, name: MAP_ICON.DROP_POINT, label: ""});
        this.fooIcon = ki25;
        this.mapContainer.addChild(ki25);
        const ki26 = new MapIcon({x: 3165, y: 1863, name: MAP_ICON.FAST_TRAVEL, label: "SUTTER ST"});
        this.fooIcon = ki26;
        this.mapContainer.addChild(ki26);
        const ki27 = new MapIcon({x: 3189, y: 1755, name: MAP_ICON.GUN_FOR_HIRE, label: "TROUBLESOME NEIGHBORS"});
        this.fooIcon = ki27;
        this.mapContainer.addChild(ki27);
        const ki28 = new MapIcon({x: 3177, y: 1776, name: MAP_ICON.SOS_MERC_NEEDED, label: "HIPPOCRATIC OATH"});
        this.fooIcon = ki28;
        this.mapContainer.addChild(ki28);
        const ki29 = new MapIcon({x: 3159, y: 1794, name: MAP_ICON.SOS_MERC_NEEDED, label: "Concrete Cage Trap"});
        this.fooIcon = ki29;
        this.mapContainer.addChild(ki29);
        const ki30 = new MapIcon({x: 3348, y: 1806, name: MAP_ICON.ASSAULT, label: ""});
        this.fooIcon = ki30;
        this.mapContainer.addChild(ki30);
        const ki31 = new MapIcon({x: 3357, y: 1800, name: MAP_ICON.ASSAULT, label: ""});
        this.fooIcon = ki31;
        this.mapContainer.addChild(ki31);
        const ki32 = new MapIcon({x: 3408, y: 1713, name: MAP_ICON.FAST_TRAVEL, label: "CHARTER ST"});
        this.fooIcon = ki32;
        this.mapContainer.addChild(ki32);
        const ki33 = new MapIcon({x: 3336, y: 1758, name: MAP_ICON.GUN_FOR_HIRE, label: "SHARK IN THE WATER"});
        this.fooIcon = ki33;
        this.mapContainer.addChild(ki33);
        const ki34 = new MapIcon({x: 3321, y: 1758, name: MAP_ICON.ASSAULT, label: ""});
        this.fooIcon = ki34;
        this.mapContainer.addChild(ki34);
    }
