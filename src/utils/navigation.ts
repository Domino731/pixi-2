...
export class Navigation {
    ...
    public screenContainer = new Container();
    ...
    constructor() {
        this.screenContainer.width = 300;
        const navigationBar = new NavigationBar(this);
        this.screenContainer.addChild(navigationBar.getContainer());
    ...
    private async addAndShowScreen(screen: AppScreen) {
        ...
        if (!this.container.parent) {
            this.screenContainer.addChild(this.container);
        }
